...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    image_processor = getattr(
        vision_tower_cfg,
        "image_processor",
        getattr(vision_tower_cfg, "image_processor", "../processor/clip-patch14-336"),
    )
...
def build_vision_tower_aux(vision_tower_cfg, **kwargs):
    ...
    if "openclip" in vision_tower_aux.lower() or "convnext" in vision_tower_aux.lower():
