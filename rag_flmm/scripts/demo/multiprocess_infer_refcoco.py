...
def do_kmeans(feature_map, gt_mask):
    ...
    ious = compute_mask_IoU(
        masks.reshape(2, -1), torch.from_numpy(gt_mask).float().reshape(1, -1)
    )[-1]
...
if __name__ == "__main__":
    ...
    png_dataset = RefCocoDataset(
        ann_file="/home/hrkim/dataset/refer_seg/refcocog/instances.json",
        split_file="/home/hrkim/dataset/refer_seg/refcocog/refs(umd).p",
        split="val",
        data_root="/home/hrkim/dataset/refer_seg/images/mscoco/",
