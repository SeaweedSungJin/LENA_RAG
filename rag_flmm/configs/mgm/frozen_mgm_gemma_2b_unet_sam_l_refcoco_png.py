...
mgm_name = "/home/hrkim/f-lmm/checkpoints/MGM-2B"
unet = dict(
    type=UNetHead,
...
tokenizer = dict(
    type=AutoTokenizer.from_pretrained, pretrained_model_name_or_path=mgm_name
)
...
model = dict(
    ...
    model=dict(
        type=MGMGemmaForCausalLM.from_pretrained,
        pretrained_model_name_or_path=mgm_name,
        mm_vision_tower="/home/hrkim/f-lmm/checkpoints/clip-vit-large-patch14-336",
        mm_vision_tower_aux="/home/hrkim/f-lmm/checkpoints/CLIP-convnext_large_d_320.laion2B-s29B-b131K-ft-soup",
...
# load_from = "/home/hrkim/f-lmm/checkpoints/flmm_checkpoints/frozen_mgm_gemma_2b_unet_sam_l_refcoco_png.pth"
load_from = None
