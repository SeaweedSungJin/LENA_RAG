...
from flmm.datasets.hpt_processors import CustomHPT15ImageProcessor
...
image_size = 448
hpt_name = "HyperGAI/HPT1_5-Air-Llama-3-8B-Instruct-multimodal"
unet = dict(
    type=UNetHead,
...
image_processor = dict(
    type=CustomHPT15ImageProcessor.from_pretrained,
    pretrained_model_name_or_path=hpt_name,
