QUESTION_ALL = [
    "Segment the entire image and classify each category separately.",
...
ANSWER_ALL = [
    "Sure, here is the segmented image with each category classified separately:",
...
QUESTION_PARTIAL = [
    "Please segment only the [class_name] in the image.",
...
ANSWER_PARTIAL = [
    "Sure, here is the segmentation mask for '[class_name]':",
...
QUESTION_CONDITION = [
    "Please segment the image based on the category: [class_name].",
...
ANSWER_CONDITION = [
    "Sure, here is the segmentation based on the category '[class_name]':",
...
QUESTION_OBJECT_ALL = [
    "Could you please segment the [object] in detail?",
...
ANSWER_OBJECT_ALL = [
    "Sure, the segmented map of the [object] is:",
...
QUESTION_OBJECT_PART = [
    "Please segment the [part] of the [object] in this image.",
...
ANSWER_OBJECT_PART = [
    "Sure, here is the segmentation mask for the [part] of the [object]:",
